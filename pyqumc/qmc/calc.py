...
from pyqumc.utils.misc import serialise
from pyqumc.walkers.handler import Walkers
from pyqumc.qmc.comm import FakeComm
...
def read_input(input_file, comm, verbose=False):
    ...
    if comm.rank == 0:
        if verbose:
            print('# Initialising pyqumc simulation from %s'%input_file)
