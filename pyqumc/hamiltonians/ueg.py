...
import math
import time
from pyqumc.utils.io import write_qmcpack_sparse
...
class UEG(object):
    ...
    def __init__(self, system, options, verbose=False):
        ...
        (self.sp_eigv, self.basis, self.nmax) = self.sp_energies(system.ktwist, system.kfac, system.ecut)
