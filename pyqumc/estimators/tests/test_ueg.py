...
def test_build_J():
    ...
    from pyqumc.estimators.ueg import build_J
    J1 = timeit(build_J)(ham, Gpmq, Gkpq)
    from pyqumc.estimators.ueg_kernels import build_J_opt
...
def test_build_K():
    ...
    G = numpy.array([gab(psi[:,:sys.nup], psi[:,:sys.nup]),
                     gab(psi[:,sys.nup:],
                         psi[:,sys.nup:])]).astype(numpy.complex128)
    from pyqumc.estimators.ueg import build_K
    from pyqumc.estimators.ueg_kernels import build_K_opt
