...
import pyqumc.propagation.hubbard
...
class BackPropagation(object):
    ...
    output : :class:`pyqumc.estimators.H5EstimatorHelper`
        Class for outputting data to HDF5 group.
    rdm_output : :class:`pyqumc.estimators.H5EstimatorHelper`
    ...
    def __init__(self, bp, root, filename, qmc, system, trial, dtype, BT2):
        ...
        if trial.type == 'GHF':
            ...
            self.back_propagate = pyqumc.propagation.hubbard.back_propagate_ghf
        else:
