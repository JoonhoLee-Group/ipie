...
class ITCF(object):
    ...
    rspace_unit : :class:`pyqumc.estimators.H5EstimatorHelper`
        Output dataset for real space itcfs.
    kspace_unit : :class:`pyqumc.estimators.H5EstimatorHelper`
        Output dataset for real space itcfs.
    """
