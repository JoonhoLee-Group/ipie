...
import sys
import time
from pyqumc.estimators.thermal import one_rdm_from_G, inverse_greens_function_qr
from pyqumc.propagation.operations import kinetic_real
from pyqumc.thermal_propagation.planewave import PlaneWave
from pyqumc.thermal_propagation.generic import GenericContinuous
from pyqumc.thermal_propagation.hubbard import HubbardContinuous
...
class Continuous(object):
    ...
    def two_body_propagator(self, walker, system, trial):
        ...
        Parameters
        ----------
        walker : :class:`pyqumc.walker.Walker` walker object to be updated. On
