...
class Hirsch(object):
    ...
    def update_greens_function_uhf(self, walker, trial, i, nup):
        ...
        Parameters
        ----------
        walker : :class:`pyqumc.walkers.SingleDet`
            Walker's wavefunction.
        trial : :class:`pyqumc.trial_wavefunction`
            Trial wavefunction.
        i : int
            Basis index.
        nup : int
    ...
    def two_body_single_site(self, walker, system, hamiltonian, trial):
        ...
        Parameters
        ----------
        walker : :class:`pyqumc.walker` object
            Walker object to be updated. On output we have acted on phi by
    ...
    def propagate_walker_free(self, walker, system, hamiltonian, trial, eshift=0):
        ...
        system : :class:`pyqumc.system.System`
            System object.
        trial : :class:`pyqumc.trial_wavefunction.Trial`
            Trial wavefunction object.
        """
...
def back_propagate_single(phi_in, configs, weights,
    ...
    Parameters
    ---------
    phi_in : :class:`pyqumc.walkers.Walker` object
        Walker.
    ...
    Returns
    -------
    psi_store : list of :class:`pyqumc.walker.Walker` objects
        Back propagated list of walkers.
    """
    nup = system.nup
    psi_store = []
...
def back_propagate_single_ghf(phi, configs, weights, system,
    ...
    Parameters
    ---------
    phi : :class:`pyqumc.walkers.MultiGHFWalker` object
        Walker.
    configs : :class:`numpy.ndarray`
        Auxilliary field configurations.
    weights : :class:`numpy.ndarray`
