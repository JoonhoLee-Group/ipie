import copy
import numpy
from pyqumc.estimators.hubbard import local_energy_hubbard_ghf
...
class MultiGHFWalker(object):
    ...
    def __init__(self, walker_opts, system, trial, index=0,
        ...
        if wfn0 != 'GHF':
            ...
            self.E_L = pyqumc.estimators.local_energy_ghf(system, self.Gi,
                                                         self.weights,
    ...
    def local_energy(self, system, two_rdm=None):
        ...
        """
        return pyqumc.estimators.local_energy_ghf(system, self.Gi,
