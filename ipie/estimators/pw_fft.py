try:
    from ipie.estimators.ueg_kernels  import  exchange_greens_function_per_qvec
except ImportError:
    pass

try:
    from ipie.estimators.ueg_kernels  import  exchange_greens_function_fft
except ImportError:
    pass
...
def unit_test():
    ...
    import numpy as np
    from ipie.estimators.greens_function import gab_mod
