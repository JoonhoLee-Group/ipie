...
from ipie.estimators.ekt import ekt_1p_fock_opt, ekt_1h_fock_opt
from ipie.propagation.generic import back_propagate_generic
from ipie.propagation.planewave import back_propagate_planewave
import ipie.propagation.hubbard
...
class BackPropagation(object):
    ...
    def __init__(self, bp, root, filename, qmc, system, trial, dtype, BT2):
        ...
        if trial.type == 'GHF':
            ...
            self.back_propagate = ipie.propagation.hubbard.back_propagate_ghf
        else:
            ...
            if system.name == "Generic":
                ...
                self.back_propagate = ipie.propagation.hubbard.back_propagate
