...
from ipie.thermal.utils.testing import build_driver_ueg_test_instance
from ipie.thermal.utils.legacy_testing import build_legacy_driver_ueg_test_instance
...
if __name__ == '__main__':
    test_thermal_afqmc_1walker(against_ref=False)
    test_thermal_afqmc()
