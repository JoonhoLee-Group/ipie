...
struct Hamiltonian {
    ...
    ipie::complex_t get_h1e(size_t p, size_t q) const;
    ipie::complex_t get_h1e_c(size_t p, size_t q) const;
    ipie::complex_t get_h2e(size_t p, size_t q, size_t r, size_t s) const;
    std::vector<ipie::complex_t> h1e;
    std::vector<ipie::complex_t> h1e_c;
