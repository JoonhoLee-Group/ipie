...
from ipie.trial_wavefunction.harmonic_oscillator import HarmonicOscillator
from ipie.estimators.ci import simple_fci_bose_fermi, simple_fci
from ipie.estimators.hubbard import local_energy_hubbard_holstein, local_energy_hubbard
...
try:
    ...
    import numpy
    from ipie.trial_wavefunction.coherent_state import gab, compute_exp
