...
from pie.estimators.greens_function import gab, gab_mod
from pie.utils.io import read_qmcpack_wfn
...
class HartreeFock(object):
    ...
    def __init__(self, system, hamiltonian, trial_opts, verbose=False, orbs=None):
        ...
        self.initial_wavefunction = trial_opts.get('initial_wavefunction',
                                              'hartree_fock')
        self.ndets = 1
        self.trial_type = numpy.complex128
        self.psi = numpy.zeros(shape=(hamiltonian.nbasis, system.nup+system.ndown),
        ...
        if self.wfn_file is not None:
            ...
            try:
                ...
                if len(orbs_matrix) == msq:
                    ...
                    orbs_alpha = orbs_matrix[:msq].reshape((hamiltonian.nbasis,
                                                        hamiltonian.nbasis))
                    orbs_beta = orbs_matrix[msq:].reshape((hamiltonian.nbasis,
                                                       hamiltonian.nbasis))
