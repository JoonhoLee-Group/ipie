...
import numpy
import scipy.linalg
from pie.estimators.thermal import greens_function, one_rdm_from_G, particle_number
from pie.estimators.local_energy import local_energy_G
from pie.walkers.stack import PropagatorStack
from pie.walkers.walker import Walker
from pie.utils.linalg import regularise_matrix_inverse
from pie.utils.misc import update_stack, get_numeric_names
...
def unit_test():
    ...
    from pie.thermal_propagation.planewave import PlaneWave
...
#### test permutation end
    ...
    from pie.estimators.thermal import greens_function, one_rdm_from_G
    from pie.estimators.hubbard import local_energy_hubbard
