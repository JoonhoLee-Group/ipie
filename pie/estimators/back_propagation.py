...
try:
    ...
    mpi_sum = None
import sys
from pie.estimators.utils import H5EstimatorHelper
from pie.estimators.greens_function import gab
from pie.estimators.local_energy import local_energy
from pie.estimators.ekt import ekt_1p_fock_opt, ekt_1h_fock_opt
from pie.propagation.generic import back_propagate_generic
from pie.propagation.planewave import back_propagate_planewave
import pie.propagation.hubbard
...
class BackPropagation(object):
    ...
    output : :class:`pie.estimators.H5EstimatorHelper`
        Class for outputting data to HDF5 group.
    rdm_output : :class:`pie.estimators.H5EstimatorHelper`
    ...
    def __init__(self, bp, root, filename, qmc, system, trial, dtype, BT2):
        ...
        if trial.type == 'GHF':
            ...
            self.back_propagate = pie.propagation.hubbard.back_propagate_ghf
        else:
            ...
            if system.name == "Generic":
                ...
                self.back_propagate = pie.propagation.hubbard.back_propagate
