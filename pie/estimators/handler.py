...
import time
import warnings
from pie.estimators.back_propagation import BackPropagation
from pie.estimators.mixed import Mixed
from pie.estimators.itcf import ITCF
...
class Estimators(object):
    ...
    system : :class:`pie.hubbard.Hubbard` / system object in general.
    ...
    def update_batch(self, qmc, system, hamiltonian, trial, psi, step, free_projection=False):
        ...
        trial : :class:`pie.trial_wavefunction.X' object
            Trial wavefunction class.
        psi : :class:`pie.walkers.WalkersBatch` object
            CPMC wavefunction.
        step : int
            Current simulation step
        free_projection : bool
