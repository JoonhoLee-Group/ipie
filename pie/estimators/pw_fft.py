try:
    from pie.estimators.ueg_kernels  import  exchange_greens_function_per_qvec
except ImportError:
    pass

try:
    from pie.estimators.ueg_kernels  import  exchange_greens_function_fft
except ImportError:
    pass

import time
from pie.estimators.ueg import coulomb_greens_function
from pie.estimators.utils import convolve
import numpy
import itertools
import scipy.signal
...
def local_energy_pw_fft(system, G, Ghalf, trial, two_rdm=None):
    ...
    # ke = numpy.einsum('sij,sij->', system.H1, G) # Correct pie convention
    if (system.diagH1):
...
def unit_test():
    ...
    import numpy as np
    from pie.estimators.greens_function import gab_mod
